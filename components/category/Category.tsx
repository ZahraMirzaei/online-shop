...
const Category = () => {
  ...
  return (
    <div className="my-4 lg:my-10 flex flex-col">
      <h2 className="mx-auto mt-4 py-8 md:text-xl lg:text-2xl">
        {t.CategoryOfGoods}
      </h2>
      ...
      <div className="hidden lg:grid  gap-4 grid-rows-9 grid-cols-2 md:grid-cols-9 max-w-[1700px] mx-auto">
        <div className="flex justify-around items-center md:row-span-6 md:col-span-3 bg-palette-digitalCategory py-8 px-4  rounded-md shadow-lg overflow-hidden">
          <div>
            ...
            <Link href="/">
              <a className="inline-block shadow-lg border-none bg-palette-primary text-palette-side py-3 px-4 rounded-lg mt-4 text-sm">
                {t.seeAllProducts}
              </a>
            </Link>
          </div>
        ...
        <div className="flex justify-around items-center md:row-span-6 md:col-span-3 bg-palette-fashionCategory  rounded-md shadow-lg px-4 ">
          <div>
            ...
            <Link href="/">
              <a className="inline-block shadow-lg border-none bg-palette-primary text-palette-side py-3 px-2 xl:px-4 rounded-lg mt-4 text-[12px] xl:text-sm">
                {t.seeAllProducts}
              </a>
            </Link>
          </div>
          ...
          <Image
            ...
            width={240}
            height={250}
            className="drop-shadow-lg self-start"
          />
        </div>
        ...
        <div className="flex flex-col justify-around items-center md:row-span-2 md:col-span-2 rounded-md shadow-lg bg-palette-toyCategory">
          <div className="text-center">
            ...
            <Link href="/">
              <a className="inline-block shadow-lg border-none bg-palette-primary text-palette-side py-3 px-4 rounded-lg mt-3 text-sm">
                {t.seeAllProducts}
              </a>
            </Link>
          </div>
        ...
        <div className="flex justify-around items-center md:row-span-2 md:col-span-2 rounded-md shadow-lg px-3 bg-palette-stationeryCategory">
          <div className="">
            ...
            <Link href="/">
              <a className="inline-block shadow-lg border-none bg-palette-primary text-palette-side py-3 px-2 rounded-lg mt-3 text-[10px] xl:text-[12px]">
                {t.seeAllProducts}
              </a>
            </Link>
          </div>
